...
abstract public class D3Shape {
	...
	public void setVertexBuffer(FloatBuffer vertBuffer) {
		...
		if (vertBuffer != null) VERTICES_NUM = vertBuffer.capacity()/SpriteManager.COORDS_PER_VERTEX;
		else {
			VERTICES_NUM = 0;
	...
	public void drawBuffer(FloatBuffer vertexBuffer, float[] modelMatrix) {
		...
		GLES20.glVertexAttribPointer(mPositionHandle, SpriteManager.COORDS_PER_VERTEX, 
