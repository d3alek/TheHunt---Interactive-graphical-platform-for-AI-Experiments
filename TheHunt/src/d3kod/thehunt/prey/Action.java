...
public enum Action {
	TURN_LEFT_SMALL(Prey.flopBackTicks/2), TURN_LEFT_MEDIUM(Prey.flopBackTicks/2), 
	TURN_LEFT_LARGE(Prey.flopBackTicks), 
	TURN_RIGHT_SMALL(Prey.flopBackTicks/2), TURN_RIGHT_MEDIUM(Prey.flopBackTicks/2), 
