...
public enum TurnAngle {
	...
	BACK_LEFT_SMALL(PreyData.angleFlopBackSmall), BACK_LEFT_MEDIUM(PreyData.angleFlopBackMedium), BACK_LEFT_LARGE(PreyData.angleFlopBackLarge), 
	BACK_RIGHT_SMALL(-PreyData.angleFlopBackSmall), BACK_RIGHT_MEDIUM(-PreyData.angleFlopBackMedium), BACK_RIGHT_LARGE(-PreyData.angleFlopBackLarge), 
