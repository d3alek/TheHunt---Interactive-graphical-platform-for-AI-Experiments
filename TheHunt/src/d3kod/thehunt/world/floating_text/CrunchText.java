...
public class CrunchText extends D3FadingText {
	private static final float textSize=0.10f;
	...
	public CrunchText(float x, float y, TextureManager tm, ShaderProgramManager sm) {
		super(textSize, fadingSpeed, tm.getTextureHandle(Texture.CRUNCH_TEXT), sm, 0.1f);
