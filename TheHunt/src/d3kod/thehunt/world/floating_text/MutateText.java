...
public class MutateText extends D3FadingText {
	
	private static final float textSize= 1.5f;
	private static final float fadingSpeed=0.03f;
	private static final float SHIFT_LENGTH = 0.01f;
	private static final float RANDOM_ROT_MAX = 50;
	
	public MutateText(String text, float x, float y)  {
